...
import { Section, Card, CardHeader, Button, Input } from '@/components/ui';
import { Search, ClipboardList, AlertTriangle, BarChart2, FileText, Sparkles, Trash2, Copy } from 'lucide-react';
